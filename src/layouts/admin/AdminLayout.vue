<template>
  <div class="w-full h-full min-h-full overflow-hidden flex flex-row self-stretch items-start min-w-1200px">
    <div class="flex flex-col h-full w-left-menu bg-bg-page relative flex-shrink-0">
      ...
      <div class="flex flex-row items-center w-full p-spacing">
        ...
        <div class="text-size-medium font-semibold ml-spacing-xxs">CODE EDITOR DEMO</div>
      </div>
      <Menu :layout="layout" />
    </div>
